...
Por otro lado, dado que actualmente la plataforma funciona solo con un servidor, el número máximo de peticiones que un usuario puede realizar al día es de 10, es decir que solamente porá eniar 10 pruebas realizadas al servidor, si los subsistemas itentan enviar más de 10 al día, el servidor arrojará una respuesta de error.
